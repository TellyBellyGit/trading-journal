...
const OriginalDashboard = () => {
    ...
    return (_jsxs("div", { className: "p-6 space-y-6", children: [_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: metrics.map((metric, index) => (_jsxs("div", { className: "bg-gray-800 border border-gray-700 rounded-lg p-6 hover:border-gray-600 transition-colors", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsx("h3", { className: "text-gray-400 text-sm font-medium", children: metric.title }), _jsx("span", { className: "text-2xl", children: metric.icon })] }), _jsx("p", { className: `text-2xl font-bold ${metric.color === 'blue' ? 'text-blue-400' :
                                metric.color === 'green' ? 'text-green-400' :
                                    metric.color === 'red' ? 'text-red-400' :
                                        metric.color === 'purple' ? 'text-purple-400' :
                                            'text-orange-400'}`, children: metric.value })] }, index))) }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [_jsxs("div", { className: "lg:col-span-2 bg-gray-800 border border-gray-700 rounded-lg", children: [_jsxs("div", { className: "p-6 border-b border-gray-700 flex items-center justify-between", children: [_jsx("h3", { className: "text-lg font-semibold text-white", children: "Recent Trades" }), _jsx("button", { onClick: loadDashboardData, className: "text-sm text-blue-400 hover:text-blue-300 transition-colors", children: "\uD83D\uDD04 Refresh" })] }), _jsx("div", { className: "p-6", children: recentTrades.length === 0 ? (_jsxs("div", { className: "text-center py-8", children: [_jsx("div", { className: "text-4xl mb-4", children: "\uD83D\uDCCA" }), _jsx("p", { className: "text-gray-400", children: "No trades found" }), _jsx("p", { className: "text-gray-500 text-sm mt-2", children: "Create your first trade to get started!" })] })) : (_jsx("div", { className: "space-y-4", children: recentTrades.map((trade) => (_jsxs("div", { className: "flex items-center justify-between py-3 border-b border-gray-700 last:border-b-0", children: [_jsxs("div", { className: "flex items-center space-x-4", children: [_jsx("div", { className: "w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center", children: _jsx("span", { className: "text-white font-bold text-sm", children: trade.symbol.slice(0, 2) }) }), _jsxs("div", { children: [_jsx("p", { className: "text-white font-medium", children: trade.symbol }), _jsx("p", { className: "text-gray-400 text-sm", children: trade.direction })] })] }), _jsxs("div", { className: "text-right", children: [_jsx("p", { className: `font-semibold ${trade.profitLoss && trade.profitLoss >= 0 ? 'text-green-400' : 'text-red-400'}`, children: trade.profitLoss ? formatCurrency(trade.profitLoss) : 'Open' }), _jsx("p", { className: `text-xs ${trade.status === 'Open' ? 'text-blue-400' : 'text-gray-400'}`, children: trade.status })] })] }, trade.id))) })) })] }), _jsxs("div", { className: "bg-gray-800 border border-gray-700 rounded-lg", children: [_jsx("div", { className: "p-6 border-b border-gray-700", children: _jsx("h3", { className: "text-lg font-semibold text-white", children: "Quick Actions" }) }), _jsx("div", { className: "p-6 space-y-4", children: [
              ...
              `, children: [_jsx("span", { className: "text-lg", children: action.icon }), _jsx("span", { className: "font-medium", children: action.label })] }, index))) })] })] }), _jsxs("div", { className: "bg-gray-800 border border-gray-700 rounded-lg", children: [_jsx("div", { className: "p-6 border-b border-gray-700", children: _jsx("h3", { className: "text-lg font-semibold text-white", children: "Performance Overview" }) }), _jsx("div", { className: "p-6", children: _jsx("div", { className: "h-64 bg-gray-700/50 rounded-lg flex items-center justify-center", children: _jsxs("div", { className: "text-center", children: [_jsx("span", { className: "text-4xl", children: "\uD83D\uDCC8" }), _jsx("p", { className: "text-gray-400 mt-2", children: "Performance Chart" }), _jsx("p", { className: "text-gray-500 text-sm", children: stats?.totalTrades ? `Based on ${stats.totalTrades} trades` : 'Component coming next...' })] }) }) })] })] }));
};
const DashboardSelector = ({ currentView, onViewChange }) => {
    ...
    _jsx("div", { className: "p-6 border-b border-gray-700", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-xl font-bold text-white", children: "Dashboard View" }), _jsx("p", { className: "text-gray-400 text-sm", children: "Choose your preferred dashboard layout" })] }), _jsxs("div", { className: "flex space-x-2", children: [_jsx("button", { onClick: () => onViewChange('original'), className: `
            ...
            `, children: "\uD83D\uDCCA Original Dashboard" }), _jsx("button", { onClick: () => onViewChange('enhanced'), className: `
              px-4 py-2 rounded-lg font-medium transition-all duration-200
              ${currentView === 'enhanced'
                                ? 'bg-purple-600 text-white shadow-lg'
                                : 'bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white'}
            `, children: "\u26A1 Enhanced Metrics" }), _jsx("button", { onClick: () => onViewChange('all-trades'), className: `
              px-4 py-2 rounded-lg font-medium transition-all duration-200
              ${currentView === 'all-trades'
                                ? 'bg-green-600 text-white shadow-lg'
                                : 'bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white'}
            `, children: "\uD83D\uDCCB Trades" })] })] }) })); // Add closing parenthesis and semicolon
};
// Main App Component
function App() {
    ...
    const renderContent = () => {
        ...
        return (_jsxs("div", { children: [_jsx(DashboardSelector, { currentView: currentView, onViewChange: handleViewChange }), _jsxs("div", { className: "transition-all duration-300", children: [currentView === 'original' && _jsx(OriginalDashboard, {}), currentView === 'enhanced' && _jsx(MetricsDashboard, {}), currentView === 'all-trades' && _jsx(AllTradesDemo, {})] })] }));
    };
    const getTitle = () => {
