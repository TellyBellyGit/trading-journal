                  ...
                  <tr key={trade.id} className="hover:bg-gray-700/50">
                    <td className="px-4 py-3">
                      <button
                        ...
                        className="flex items-center space-x-2 hover:bg-gray-600 rounded p-1 transition-colors group"
                      >
                        ...
                        <span className="font-medium text-white group-hover:text-blue-400">{trade.symbol}</span>
                      </button>
                    </td>
                    <td className="px-4 py-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredAndSortedTrades.map((trade) => (
            <div key={trade.id} className="bg-gray-800 border border-gray-700 rounded-lg p-6 hover:border-gray-600 transition-colors">
              <button
                onClick={() => handleSymbolClick(trade.id)}
                className="flex items-center space-x-3 mb-4 w-full text-left hover:bg-gray-700 rounded p-2 transition-colors group"
              >
                <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center group-hover:bg-blue-500">
                  <span className="text-white font-bold text-sm">{trade.symbol.slice(0, 2)}</span>
                </div>
                <div>
                  <h3 className="font-semibold text-white group-hover:text-blue-400">{trade.symbol}</h3>
