...
const AllTradesDemo = () => {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "bg-gray-800 border border-gray-700 rounded-lg p-6", children: [_jsx("h2", { className: "text-lg font-semibold text-white mb-4", children: "All Trades Component Demo" }), _jsxs("div", { className: "flex flex-wrap gap-4 mb-4", children: [_jsx("button", { onClick: handleRefresh, className: "btn-primary", disabled: loading, children: loading ? '🔄 Loading...' : '🔄 Generate New Data' }), _jsx("button", { onClick: () => setTrades([]), className: "btn-secondary", children: "\uD83D\uDDD1\uFE0F Clear All Trades" }), _jsx("button", { onClick: () => setTrades(generateSampleTrades()), className: "btn-secondary", children: "\uD83D\uDCCA Reset Sample Data" })] }), _jsxs("div", { className: "text-sm text-gray-400 space-y-1", children: [_jsx("p", { children: _jsx("strong", { children: "Features demonstrated:" }) }), _jsxs("ul", { className: "list-disc list-inside space-y-1 ml-4", children: [_jsx("li", { children: "Advanced filtering (Symbol, Direction, Status, Assessment, Date Range, P/L Range)" }), _jsx("li", { children: "Multi-column sorting with visual indicators" }), _jsx("li", { children: "Bulk selection with checkbox controls" }), _jsx("li", { children: "Table and Cards view modes" }), _jsx("li", { children: "Real-time summary statistics" }), _jsx("li", { children: "Responsive design for mobile/desktop" }), _jsx("li", { children: "Edit/Delete actions for individual trades" }), _jsx("li", { children: "Professional data formatting (currency, percentages, dates)" }), _jsx("li", { children: "Empty state handling" }), _jsx("li", { children: "Loading states and animations" })] })] })] }), _jsx(AllTrades, { trades: trades, loading: loading, onTradeEdit: handleTradeEdit, onTradeDelete: handleTradeDelete, onTradeAdd: handleTradeAdd, onExport: handleExport })] }));
};
